...
require (
	...
	github.com/cloudfoundry/bosh-agent v2.224.0+incompatible // indirect
	github.com/cloudfoundry/bosh-cli v5.5.1+incompatible
	github.com/cloudfoundry/bosh-davcli v0.0.33 // indirect
	github.com/cloudfoundry/bosh-gcscli v0.0.6 // indirect
	github.com/cloudfoundry/bosh-s3cli v0.0.80 // indirect
	github.com/cloudfoundry/bosh-utils v0.0.0-20190601100208-cfea189696fa
	github.com/cloudfoundry/config-server v0.1.15
