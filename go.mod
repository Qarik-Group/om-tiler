...
require (
	...
	github.com/cloudfoundry/bosh-agent v2.231.0+incompatible // indirect
	...
	github.com/cloudfoundry/config-server v0.1.17
	...
	github.com/pivotal-cf/om v0.0.0-20190705141125-7ae3101d2f64
